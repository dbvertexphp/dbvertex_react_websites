...
function Header() {
  ...
  <div className="container-fluid">
   <Link className="navbar-brand" to="/"><img  className="logo_header" src="/images/dbvertex_logo.png" alt="dbvertex_logo" /></Link>
    <button className="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasHeader" aria-controls="offcanvasHeaderLabel" aria-expanded="false" aria-label="Toggle navigation">   
      <span className=""><img  className="Header_navbar_icon" src="/images/menu.png" alt="menu" /></span>
    </button>
...
<div className="offcanvas offcanvas-end " data-bs-scroll="true" tabindex="-1" id="offcanvasHeader" aria-labelledby="offcanvasHeaderLabel">
  ...
  <ul className="navbar-nav m-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item mb-2">
         <Link className="nav-link header_option" to="/">About Us</Link>
        </li>
        <li className="nav-item mb-2">
         <Link className="nav-link header_option" to="/">Services</Link>
        </li>
        <li className="nav-item mb-2">
         <Link className="nav-link header_option"  to="/">Portfolio</Link>
        </li>
      </ul>
  </div>
</div>
